...
const Screen = (props) => {
  ...
  return (
    <>
        <div className='first-card background relative flex justify-center items-center rounded w-full lg:w-[600px] h-40 lg:h-[400px] shadow-[0_5px_26px_8px_rgb(86,155,81)]'>
